...
import com.minhyeok.readingbooks.databinding.ActivitySameAuthorBooksBinding
...
class SameAuthorActivity : AppCompatActivity() {
    ...
    private fun fetchUserBookIsbns(onResult: (List<String>) -> Unit) {
        ...
        SupabaseClient.create().getUserBooksByUserId("eq.$uid")
            .enqueue(object : Callback<List<com.minhyeok.readingbooks.data.UserBook>> {
                override fun onResponse(
                    call: Call<List<com.minhyeok.readingbooks.data.UserBook>>,
                    response: Response<List<com.minhyeok.readingbooks.data.UserBook>>
                ) {
                    if (response.isSuccessful) {
                ...
                override fun onFailure(call: Call<List<com.minhyeok.readingbooks.data.UserBook>>, t: Throwable) {
